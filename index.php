  ...
  <body>
    ...
    <div class="container-fluid p-0">
      <div class="owl-carousel header-carousel position-relative">
              ...
              <div class="row justify-content-start">
                <div class="col-sm-10 col-lg-8">
                  ...
                  <div class="my-3">
                    <a
                      href="about.php"
                      class="btn btn-primary py-2 py-md-3 px-md-5 me-3 animated slideInLeft"
                      >Read More</a
                    >
                    <a
                      href="register.php"
        ...
        <div class="owl-carousel-item position-relative">
          <img
            class="img img-fluid opacity-25"
            ...
            <div class="container">
              <div class="row justify-content-start">
                <div class="col-sm-10 col-lg-8">
                  ...
                  <a
                    href="tel:+255784956894"
                    class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft"
                  >
                    <i class="fa fa-phone-alt"></i> Call Us</a
                  >
                  <a
                    href="mailto:saidabdallahmgote@gmail.com"
                    class="btn btn-light py-md-3 px-md-5 animated slideInRight"
                  >
        ...
        <div class="row g-5 my-4 py-2 box-shadow-container">
          ...
          >
            <div class="position-relative h-100">
              <img
                class="img-fluid img-rounded-circle position-absolute w-100 h-100"
    ...
    <div class="py-5 px-2 package-section">
      ...
      <div class="container">
        <div
          class="row g-4 d-md-flex align-items-stretch justify-content-between align-items-center"
        >
          <div
            class="col-lg-5 col-sm-6 wow fadeInUp container-package py-2 border-bottom border-1 border-primary"
            data-wow-delay="0.3s"
          >
            <div
              class="package-info text-center pt-3 pb-2 border-bottom border-1 border-secondary"
            >
              <div class="p-4">
                <h3>1 Month</h3>
              </div>
              <div class="my-3">
                ...
                <span
                  class="ms-3 py-3 px-4 text-light badge rounded-pill bg-info"
                  >SAVE 33%</span
                >
              </div>
              <div class="my-3">
                <span class="display-6">Tsh 8000/</span
                ><span class="text-primary duration">mo</span>
              </div>
              <div class="my-3">+1 month FREE</div>
              <div class="my-3 d-flex justify-content-center w-100">
                <button class="btn btn-info btn-lg">
                  <a href="register.php" class="text-light text-decoration-none"
                    >Be a member</a
                  >
                </button>
              </div>
          ...
          <div
            class="col-lg-5 col-sm-6 wow fadeInUp container-package pb-2 border-bottom border-1 border-primary"
            data-wow-delay="0.3s"
          >
            <div
              class="package-info text-center pt-3 pb-2 border-bottom border-1 border-secondary"
            >
              ...
              <div class="my-3">
                <span class="display-6">Tsh 3000/</span
                ><span class="text-primary duration">week</span>
              </div>
              <div class="my-3">+1 month FREE</div>
              <div class="my-3 d-flex justify-content-center w-100">
                <button class="btn btn-info btn-lg">
              ...
              >
                <div class="bg-light d-flex justify-content-center pt-2 px-1">
                  <a
                    ...
                    href="https://www.facebook.com/said.mgote"
                    ><i class="fab fa-facebook-f"></i
                  ></a>
                  <a
                    class="btn btn-sm-square btn-primary mx-1"
                    href="https://www.instagram.com/saidmgote/"
