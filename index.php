          ...
          <div class="container">
            <div class="row justify-content-start">
              <div class="col-sm-10 col-lg-8">
                ...
                <div class="my-3">
                  <a href="about.php" class="btn btn-primary py-2 py-md-3 px-md-5 me-3 animated slideInLeft">Read
                    More</a>
          ...
          <div class="container">
            <div class="row justify-content-start">
              <div class="col-sm-10 col-lg-8">
                ...
                <a href="tel:+255784956894" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">
                  <i class="fa fa-phone-alt"></i> Call Us</a>
                <a href="mailto:saidabdallahmgote@gmail.com" class="btn btn-light py-md-3 px-md-5 animated slideInRight">
  ...
  <div class="py-5 about-section">
    <div class="container">
      <div class="row g-5 my-4 py-2 box-shadow-container">
        <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s" style="min-height: 400px">
          <div class="position-relative h-100">
            <img class="img-fluid img-rounded-circle position-absolute w-100 h-100" src="img/lab5.jpg" alt="" style="object-fit: cover" />
          </div>
        </div>
      ...
      <div class="row g-5 my-4 py-2 box-shadow-container">
        ...
        <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s" style="min-height: 400px">
          <div class="position-relative h-100">
            <img class="img-fluid position-absolute w-100 h-100" src="img/student-in-the-classroom.jpg" alt="" style="object-fit: cover" />
          </div>
        </div>
      </div>
      <div class="row g-5 my-4 py-2 box-shadow-container">
        ...
        <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s" style="min-height: 400px">
          <div class="position-relative h-100">
            <img class="img-fluid position-absolute w-100 h-100" src="img/lab4.jpg" alt="alert" style="object-fit: cover" />
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="py-5 px-2 package-section">
    ...
    <div class="container">
      <div class="row g-4 d-md-flex align-items-stretch justify-content-between align-items-center">
        <div class="col-lg-5 col-sm-6 wow fadeInUp container-package py-2 border-bottom border-1 border-primary" data-wow-delay="0.3s">
        ...
        <div class="col-lg-5 col-sm-6 wow fadeInUp container-package pb-2 border-bottom border-1 border-primary" data-wow-delay="0.3s">
          <div class="package-info text-center pt-3 pb-2 border-bottom border-1 border-secondary">
            <div class="p-4">
              <h3>1 Week</h3>
            </div>
          ...
          <div class="team-item bg-light">
            ...
            <div class="position-relative d-flex justify-content-center" style="margin-top: -23px">
              <div class="bg-light d-flex justify-content-center pt-2 px-1">
                <a class="btn btn-sm-square btn-primary mx-1" href="https://www.facebook.com/said.mgote"><i class="fab fa-facebook-f"></i></a>
                <a class="btn btn-sm-square btn-primary mx-1" href="https://www.instagram.com/saidmgote/"><i class="fab fa-instagram"></i></a>
              </div>
            </div>
